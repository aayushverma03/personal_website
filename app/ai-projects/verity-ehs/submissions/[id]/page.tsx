...
import { Checkbox } from "@/app/components/ehs/ui/checkbox"
import { Label } from "@/app/components/ehs/ui/label"
import { Textarea } from "@/app/components/ehs/ui/textarea"
import { Skeleton } from "@/app/components/ehs/ui/skeleton"
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, DialogDescription } from "@/app/components/ehs/ui/dialog"
import { getApproval, getChecklist, submitChecklist } from "@/app/lib/ehs-api"
import { mockChecklistSteps } from "@/app/lib/ehs-mocks"
        ...
        <main className="min-h-screen pt-20 pb-24 md:pt-24 md:pb-8 px-4">
          <div className="max-w-2xl mx-auto text-center py-12">
            ...
            <Button asChild className="min-h-[44px] ehs-btn-primary">
              <Link href="/ai-projects/verity-ehs/approvals">Back to Permits</Link>
            </Button>
          </div>
        </main>
      </>
    ...
    <>
      ...
      <main className="min-h-screen pt-20 pb-24 md:pt-24 md:pb-8 px-4">
        <div className="max-w-2xl mx-auto">
          <Link
            href={`/ai-projects/verity-ehs/approvals/${approvalId}`}
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full min-h-[48px] ehs-btn-primary"
                >
