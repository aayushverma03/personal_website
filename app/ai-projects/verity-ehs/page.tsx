...
export default function Home() {
  ...
  const features = [
    { icon: FileText, label: t.nav.docs, href: "/ai-projects/verity-ehs/documents", color: "bg-blue-600" },
    { icon: Shield, label: t.nav.permits, href: "/ai-projects/verity-ehs/approvals", color: "bg-amber-600" },
    { icon: HelpCircle, label: t.nav.faq, href: "/ai-projects/verity-ehs/faq", color: "bg-purple-600" },
  ]
