...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/app/components/ehs/ui/select"
import { createApproval, getRiskScore, getRiskPrefill } from "@/app/lib/ehs-api"
...
export default function NewApprovalPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/ai-projects/verity-ehs/approvals/${approval.id}`)
    } catch (err) {
    ...
    <>
      ...
      <main className="min-h-screen pt-20 pb-24 md:pt-24 md:pb-8 px-4">
        <div className="max-w-2xl mx-auto">
          <Link
            href="/ai-projects/verity-ehs/approvals"
