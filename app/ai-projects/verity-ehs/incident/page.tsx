...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter } from "@/app/components/ehs/ui/dialog"
import { getIncidentLookup } from "@/app/lib/ehs-api"
              ...
              <CardContent className="space-y-6">
                ...
                {reportSent ? (
                  ...
                  <Button
                    ...
                    className="w-full min-h-[44px] ehs-btn-primary"
                  >
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="flex-col sm:flex-row gap-2">
            ...
            <Button
              ...
              className="min-h-[44px] ehs-btn-primary"
            >
              <Send className="h-4 w-4 mr-2" />
              {reportSending
