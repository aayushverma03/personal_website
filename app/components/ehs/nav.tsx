...
import { cn } from "@/app/lib/ehs-utils"
import { clearToken, getUserName } from "@/app/lib/ehs-auth"
...
const navItems: Array<{ href: string; key: NavKey; icon: typeof Home; color: string }> = [
  { href: "/ai-projects/verity-ehs", key: "home", icon: Home, color: "text-teal-600" },
  { href: "/ai-projects/verity-ehs/documents", key: "docs", icon: FileText, color: "text-blue-600" },
  { href: "/ai-projects/verity-ehs/faq", key: "faq", icon: HelpCircle, color: "text-purple-600" },
  { href: "/ai-projects/verity-ehs/approvals", key: "permits", icon: ClipboardCheck, color: "text-amber-600" },
  { href: "/ai-projects/verity-ehs/incident", key: "incident", icon: AlertTriangle, color: "text-rose-600" },
]
...
export function Nav() {
  ...
  function handleLogout() {
    clearToken()
    window.location.href = "/ai-projects/verity-ehs/login"
  }
  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed top-0 left-0 right-0 h-16 bg-white border-b border-stone-200 z-40 items-center px-6">
        <Link href="/ai-projects/verity-ehs" className="flex items-center mr-10">
      ...
      <nav className="md:hidden fixed top-0 left-0 right-0 h-14 bg-white border-b border-stone-200 z-40 flex items-center justify-between px-4">
        <Link href="/ai-projects/verity-ehs">
